...
{
    const redirectionCatalogueModele = () =>
    {
      alert("catalogue des modèles indisponible");
    }

    const creationProjet = () =>
    {
        alert("base de données des projet indisponible");
    }
      ...
      >
        ...
        >
          <form>
            ...
            <button type="button" onClick={redirectionCatalogueModele} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div className="flex justify-end space-x-4 mt-auto">
                ...
                <button type="button" onClick={creationProjet} className="bg-blue-700 text-white p-2 rounded-lg w-32">
                  Creer
                </button>
            </div>
          </form>
